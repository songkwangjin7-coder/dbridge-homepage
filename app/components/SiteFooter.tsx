  ...
  return (
    <footer className="bg-[#111] text-white">
      <div className="mx-auto max-w-[1600px] px-5 py-16 md:px-8 md:py-20 lg:px-12">
        ...
        {/* 상단 */}
        <div className="grid grid-cols-1 gap-12 border-b border-white/15 pb-16 lg:grid-cols-12">
        ...
        {/* 하단 */}
        <div className="flex flex-col gap-4 pt-7 text-xs text-white/30 md:flex-row md:items-center md:justify-between">
